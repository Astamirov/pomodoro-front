        ...
        <nav>
          <ul className={style.header_ul}>
            <li className={style.statistics}>
              ...
              <Link className={style.header_link} to={"/stat"}>
                {t("statistics")}
              </Link>
            </li>
            <li className={style.statistics}>
            ...
            <div className={style.header_launguage}>
              ...
              <div className={style.block_lang}>
                ...
                >
                  {russ === true ? "Русский" : "English"}
                </button>
                {open2 && (
                  <div className={style.language1}>
                ...
                <div className={style.state_profil}>
                  {!token ? (
                    <div className={style.handle_user}>
                      ...
                      <Link
                        onClick={handleOpenOff}
                        className={style.authorization_user}
                        to="/auth"
                      >
                        <span className={style.icon}>
                          <ImExit />
                    ...
                    <div className={style.profil}>
                      <button
                        className={style.btn_profil}
                        onClick={handleOpenOff}
                      >
                        <span className={style.cg_profile}>
                          <CgProfile />
                        </span>
                        <Link className={style.link_profil} to="/prof">
                          Профиль
                        </Link>
                      </button>
